...
function manageBook() {
  return (
    <div id="wrapper">
            ...
            <div className="container-fluid d-flex flex-column p-0"><a className="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="http://localhost:3000/">
                ...
                <ul className="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li className="nav-item dropdown"><a className="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="http://localhost:3000/"><i className="fas fa-book-reader" style={{fontSize: 13}}></i>&nbsp;Books Loan</a>
                        <div className="dropdown-menu"><a className="dropdown-item" href="add-loan.html" style={{paddingLeft: 30}}><i className="fas fa-plus"></i>&nbsp;Add new</a><a className="dropdown-item" href="manage-loan.html" style={{paddingLeft: 30}}><i className="fas fa-bars"></i>&nbsp;Manage all</a></div>
                    </li>
                    ...
                    <div className="container-fluid"><button className="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i className="fas fa-bars"></i></button>
                        ...
                        <ul className="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li className="nav-item dropdown no-arrow mx-1">
                                <div className="nav-item dropdown no-arrow"><a className="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="http://localhost:3000/"><span className="badge bg-danger badge-counter">3+</span><i className="fas fa-bell fa-fw"></i></a>
                            ...
                            <li className="nav-item dropdown no-arrow mx-1">
                                <div className="nav-item dropdown no-arrow"><a className="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="http://localhost:3000/"><span className="badge bg-danger badge-counter">7</span><i className="fas fa-envelope fa-fw"></i></a>
                                    <div className="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                        <h6 className="dropdown-header">alerts center</h6><a className="dropdown-item d-flex align-items-center" href="http://localhost:3000/">
                                ...
                                <table className="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1</td>
                                            <td>1</td>
                                            <td><button className="btn btn-primary btn-sm border rounded-pill" type="button">Edit</button><button className="btn btn-danger btn-sm border rounded-pill" type="button">Delete</button></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>NMML</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td><strong>http://localhost:3000/</strong></td>
        ...
        </div><a className="border rounded d-inline scroll-to-top" href="http://localhost:3000/page-top"><i className="fas fa-angle-up"></i></a>
    </div>
  );
}
