    ...
    return(
        ...
        <div className="d-flex flex-column" id="content-wrapper">
            ...
            <div className="card shadow">
                <div className="card-header py-3">
                    <p className="text-primary m-0 fw-bold">Accept users</p>
                </div>
                <div className="card-body">
                    <div className="row">
                        <div className="col-md-6 text-nowrap">
                            <div id="dataTable_length" className="dataTables_length" aria-controls="dataTable"><label className="form-label">Show&nbsp;<select className="d-inline-block form-select form-select-sm" value={itemsPerPage} onChange={handleItemsPerPageChange}>
                    ...
                    <div className="table-responsive text-nowrap table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                        <table className="table my-0" id="dataTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="text-center"><a className="btn btn-success btn-sm border rounded-pill" role="button" href="add-user.html">Accept</a><button className="btn btn-danger btn-sm border rounded-pill" type="button">Decline</button></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>20215452</td>
                                ...
                                <tr>
                                    ...
                                    <td>0971234213</td>
                                    <td className="text-center">4 months</td>
                                    <td className="text-center"><a className="btn btn-success btn-sm border rounded-pill" role="button" href="add-user.html">Aceept</a><button className="btn btn-danger btn-sm border rounded-pill" type="button">Decline</button></td>
                                </tr>
