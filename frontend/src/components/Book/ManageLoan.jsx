        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4"><strong>MANAGE LOAN</strong></h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">All loans</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table class="table table-striped my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2008/11/28</td>
                                            <td>Waiting</td>
                                            <td><a class="btn btn-primary btn-sm border rounded-pill" role="button" href="loan-detail.html">View</a></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>987213</td>
