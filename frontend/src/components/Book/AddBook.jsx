        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4"><strong>ADD BOOK</strong></h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="img-thumbnail mb-3 mt-4" src="../assets/img/dogs/image2.jpeg" width="160" height="160"/>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Fill the form</p>
                                        </div>
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Book Title</strong></label><input class="form-control" type="text" id="book-title" name="username"/></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Book ID</strong></label><input class="form-control" type="text" id="bookID" name="bookID"/></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Author</strong></label><input class="form-control" type="text" id="author" name="author"/></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Publisher</strong></label><input class="form-control" type="text" id="publisher" name="publisher"/></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Category</strong></label><select class="form-select">
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Amount</strong></label><input class="form-control" type="text" id="amount" name="amount"/></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" id="available" for="last_name"><strong>Available</strong></label><input class="form-control" type="text" id="publisher-1" name="available"/></div>
                                                    </div>
                                                </div>
                                                <div class="mb-3"><button class="btn btn-success btn-sm" type="submit" style="margin-top: 17px;">Update</button><button class="btn btn-secondary btn-sm" type="submit" style="margin-top: 17px;margin-left: 5px;">Back</button><button class="btn btn-success btn-sm" type="submit" style="margin-top: 17px;margin-left: 316px;">Import file</button></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
